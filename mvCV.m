...
energyScore   = zeros(nRep, 1);   % multivariate CRPS (energy score)
...
for r = 1:nRep
    ...
    energyScore(r)   = mean(energy_score(Yhat, preds));
...
out.crps           = energyScore;   % retained for backwards compatibility
